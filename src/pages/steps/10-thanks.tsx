    ...
    <div className="w-screen h-screen flex justify-center items-center">
      ...
      >
        ...
        <div className="text-black flex flex-col sm:flex-row gap-2 sm:gap-10 mt-3 items-center">
          <Link href={`/about`}>
            <Button className="md:text-xl transition-all hover:scale-110 active:scale-105 text-black hover:text-black bg-white hover:bg-gray-200 active:bg-gray-400" size="lg" variant="outline" >Saber más del proyecto</Button>
          </Link>
          <Link href={`/steps/1-initial`}>
            <Button className="md:text-xl transition-all hover:scale-110 active:scale-105 text-black hover:text-black bg-white hover:bg-gray-200 active:bg-gray-400" size="lg" variant="outline" >Volver a hacer el tour</Button>
          </Link>
        </div>
      </motion.div>
    </div>
