    ...
    >
      ...
      <div className="text-black flex flex-col sm:flex-row gap-2 sm:gap-10 mt-3 items-center">
        <Link href={`/steps/3-popularity`}>
          <Button className="md:text-xl transition-all hover:scale-110 active:scale-105 active:bg-slate-300" size="lg" variant="outline" >¡No sabía!</Button>
        </Link>
        <Link href={`/steps/4-risks?didKnow=true`}>
          <Button className="md:text-xl transition-all hover:scale-110 active:scale-105 active:bg-slate-300" size="lg" variant="outline" >¡Ya sabía!</Button>
        </Link>
      </div>
    </motion.div>
  )
